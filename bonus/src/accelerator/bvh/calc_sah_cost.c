...
/*   Updated: 2026/08/15 03:45:16 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static float	calc_surface_area(t_aabb const *aabb)
{
	float const	width = fmaxf(0.0f, aabb->x.max - aabb->x.min);
	float const	height = fmaxf(0.0f, aabb->y.max - aabb->y.min);
	float const	depth = fmaxf(0.0f, aabb->z.max - aabb->z.min);
