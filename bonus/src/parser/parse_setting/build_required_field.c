...
/*   Updated: 2026/07/31 00:48:26 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const t_required_field	g_required_fields[REQUIRED_FIELD_COUNT] = {\
	...
	[REQUIRED_DIAMETER] = {NULL, "diameter", parse_radius}, \
	[REQUIRED_CENTER_DIAMETER] = {NULL, "center_diameter", parse_radius}, \
	[REQUIRED_CAP_DIAMETER] = {NULL, "cap_diameter", parse_radius}, \
	[REQUIRED_HALF_HEIGHT] = {NULL, "height", parse_half_height}, \
